          ...
          >
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-3 text-center mt-10">
                <div className="border-2 border-black rounded-lg p-3 text-white bg-theme cursor-pointer hover:opacity-90">Thuê</div>
                <div className="border-2 border-gray-400 rounded-lg p-3 hover:bg-gray-100 cursor-pointer">Nhắn tin</div>
              </div>
            </div>
          </div>
        ))
